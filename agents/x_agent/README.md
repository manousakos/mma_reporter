...
## What the X agent does
This is an agent that generates a report, after analysing a list of X , for every fighter and event , from the past 24 hours.

This agent gathers the latest posts from X and extracts all the fighters and events mentioned and generates a report for each pinpointed event/fighter and then combines them all into a Markdown Report.
